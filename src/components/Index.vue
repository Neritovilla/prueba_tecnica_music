<template>
  <div class="container-fluid">
    ...
    <!--buttons songs and categories, allow data to be displayed when clicked-->
    ...
    <!--table songs is visible if click button songs and show a list with songs -->
      ...
      <table class="table table-song dark-table">
        ...
        <tbody>
          <tr v-for="song in songs" :key="song.id_song">
            ...
            <td>{{ song.duration }}</td>
            <td><button class="btn" @click="playAudio(song.audio_file)"><i class="fa fa-solid fa-play"></i></button>
            </td>
          </tr>
        </tbody>
      </table>
    ...
    <!--table categories is visible if click button categories and show a list with categories -->
      ...
      <table class="table table-category dark-table">
        ...
        <tbody>
          <tr v-for="category in categorieswithSong" :key="category.id_category">
            ...
            <td><button class="btn btn-gey" @click="showSongsModal(category.id_category, category.name)"><i
                  class="fa fa-solid fa-eye"></i></button></td>
          </tr>
        </tbody>
      </table>
    </div>
...
export default {
  ...
  methods: {
    /*make a request for obtain number of songs and categories actives*/
    async count() {
      try {
    ...
    /*make a request for obtain all songs with status active*/
    async showSongs() {
      try {
    ...
    /*make a request for obtain all categories with status active*/
    ...
    /*navigate to page SongCategory and pass params*/
